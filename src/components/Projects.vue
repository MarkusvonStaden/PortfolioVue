  ...
  >
    ...
    <div class="projects-list grid grid-cols-1 md:grid-cols-3 gap-10 w-2/3">
      <a
        ...
        class="project z-10 overflow-hidden relative inline-block rounded-2xl group min-w-fit max-w-lg w-auto aspect-square hover:shadow-[0px_0px_100px_10px_rgba(109,40,217)] hover:shadow-cyan-400/20"
      >
        <h3
        ...
        <img
          :src="project.image"
          alt=""
          class="grayscale object-cover group-hover:grayscale-0 group-hover:scale-125 duration-500 w-full"
        />
      </a>
    </div>
  </div>
